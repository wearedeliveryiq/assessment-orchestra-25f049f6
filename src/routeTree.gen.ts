...
const ApiAnalysisRunsIdRouteChildren: ApiAnalysisRunsIdRouteChildren = {
  ...
  ApiAnalysisRunsIdRecommendationResolutionRoute:
    ApiAnalysisRunsIdRecommendationResolutionRoute,
  ApiAnalysisRunsIdRecommendationSequenceRoute:
    ApiAnalysisRunsIdRecommendationSequenceRoute,
...
const ApiImprovementActionsIdRouteWithChildren =
  ApiImprovementActionsIdRoute._addFileChildren(
    ApiImprovementActionsIdRouteChildren,
  )
...
const ApiRecommendationPortfoliosIdRouteWithChildren =
  ApiRecommendationPortfoliosIdRoute._addFileChildren(
    ApiRecommendationPortfoliosIdRouteChildren,
  )
