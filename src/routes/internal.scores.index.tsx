...
export const Route = createFileRoute("/internal/scores/")({
  head: () => ({
    meta: [
      { title: "Score Explorer — DeliveryIQ" },
      {
        name: "description",
        content:
          "Internal developer tool for inspecting the weighted dimension scores produced by the DeliveryIQ Scoring Engine.",
      },
      { property: "og:title", content: "Score Explorer — DeliveryIQ" },
      {
        property: "og:description",
        content: "Inspect Scoring Engine output and its full pattern-level provenance.",
      },
    ],
  }),
  component: ScoreExplorerIndex,
});

function ScoreExplorerIndex() {
  ...
  return (
    <AppShell>
      ...
      <h1 className="mt-3 font-display text-3xl font-semibold tracking-tight">Score Explorer</h1>
      <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
        Select an assessment to inspect its weighted dimension scores, maturity levels, confidence
        and the complete evidence chain behind every number.
      </p>
