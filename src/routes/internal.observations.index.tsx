...
export const Route = createFileRoute("/internal/observations/")({
  head: () => ({
    meta: [
      { title: "Observation Explorer — DeliveryIQ" },
      {
        name: "description",
        content:
          "Internal developer tool for inspecting the observations generated by the DeliveryIQ Observation Engine.",
      },
      { property: "og:title", content: "Observation Explorer — DeliveryIQ" },
      {
        property: "og:description",
        content: "Inspect Observation Engine output and its full traceability chain.",
      },
    ],
  }),
  ...
  return (
    <AppShell>
      ...
      <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
        Select an assessment to inspect every observation generated by the Observation Engine,
        including the source question, captured answer and the knowledge pack rule that fired.
      </p>
