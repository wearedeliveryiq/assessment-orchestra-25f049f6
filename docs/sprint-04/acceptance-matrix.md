...
| AC4 rollback/recovery rehearsal passes                 | governed activation/configuration diff, feature rollback, stale-lease replay and immutable recovery contract; PDR-004-001 Tier 1 objectives filed                                                                            | catalogue rollback, feature replay, partial failure, retry and expiry tests                     | BLOCKED — Lovable lacks qualifying self-service recovery point/isolated target |
...
| Recovery                        | implementation rehearsal and rollback runbook reconciled to Tier 1 RPO <=15 minutes/RTO <=4 hours; read-only platform capability assessment recorded | BLOCKED — Lovable self-service restore is daily and in-place; qualifying isolated target unavailable |
