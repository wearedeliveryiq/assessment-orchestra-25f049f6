...
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------: | ------------------------------------------------------------------------ | ----------------------------------------------------------------------- |
| DIQ-000          | Master Index                                                                                                                                                                       |       3.6 | CONTROLLED                                                               | This document                                                           |
...
| SAR-003 v1.0     | [Sprint 03 Product Acceptance — historical](<../07-release/SAR-003 Sprint 03 Product Acceptance.md>)                                                                               |       1.0 | **SUPERSEDED**                                                           | `docs/07-release`                                                       |
| SAR-003          | [Sprint 03 Product Acceptance](<../07-release/SAR-003 v1.1 Sprint 03 Product Acceptance.md>)                                                                                       |       1.1 | **ACCEPTED WITH RECORDED LIMITATIONS**                                   | `docs/07-release`                                                       |
...
| Version | Date          | Change                                                                                                                                                                        |
| ------- | ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3.6     | 3 August 2026 | Registered SAR-003 v1.1 accepting PDR-003-004/005/A and Snapshot restart; closed the missing collection-journey limitation and retained the first-entitlement activation gate |
